import { toString as toString_1 } from "../fable-library.4.2.1/Decimal.js";
import { comparePrimitives, Lazy, disposeSafe, getEnumerator, defaultOf } from "../fable-library.4.2.1/Util.js";
import { empty, map as map_5, tryFind, add, toList } from "../fable-library.4.2.1/Map.js";
import { toString as toString_2 } from "../fable-library.4.2.1/BigInt.js";
import { toString as toString_3 } from "../fable-library.4.2.1/Date.js";
import { toString as toString_4 } from "../fable-library.4.2.1/TimeSpan.js";
import { map as map_1 } from "../fable-library.4.2.1/List.js";
import { defaultArg, map as map_2, defaultArgWith, some } from "../fable-library.4.2.1/Option.js";
import { toString as toString_5, FSharpRef } from "../fable-library.4.2.1/Types.js";
import { class_type, getGenerics, getGenericTypeDefinition, getTupleFields, getTupleElements, isTuple, isGenericType, getEnumUnderlyingType, isEnum, getElementType, isArray, getUnionCaseFields, getUnionFields, isUnion, getRecordElements, getRecordField, name, isRecord, fullName as fullName_1 } from "../fable-library.4.2.1/Reflection.js";
import { fill, map as map_3 } from "../fable-library.4.2.1/Array.js";
import { Util_CachedEncoders, Util_Cache$1__GetOrAdd_43981464, CaseStrategy, Util_Casing_convert } from "./Types.fs.js";
import { mapIndexed, map as map_4, fold } from "../fable-library.4.2.1/Seq.js";
import { toFail, printf, toText } from "../fable-library.4.2.1/String.js";
